...
public class BreedingMiniGame extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.breeding_minigame); //Page XML
        mLayout = (RelativeLayout) findViewById(R.id.breeding_minigame); //Page Background_1
